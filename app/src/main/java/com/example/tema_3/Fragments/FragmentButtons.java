...
import com.example.tema_3.Alarm.AlarmReceiver;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_set_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar != null && EXTRA_TITLE_TASK != null) {
                    startAlarm(calendar);
                    Toast.makeText(getContext(), "Notification successfully created!", Toast.LENGTH_SHORT).show();
                    closeFragment();
                }
                else Toast.makeText(getContext(), "You must select a task and choose date and time!", Toast.LENGTH_SHORT).show();
            }
        });
